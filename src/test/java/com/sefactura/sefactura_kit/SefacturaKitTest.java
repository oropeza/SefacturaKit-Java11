package com.sefactura.sefactura_kit;
 ...
 */
public class SefacturaKitTest 
{

	
	private String SEFACTURA_URL = "http://pruebas.sefactura.com.mx:3014";
	private String SEFACTURA_USUARIO = "";
	private String SEFACTURA_CLAVE = "";
	
    @Test
    public void prueba_timbrado(){
		...
		try {
			...
			assertEquals("301 - XML mal formado",rt.getResultado());
			
			rt = sf.timbrado("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + 
			...
			assertEquals("300 - Usuario no existe",rt.getResultado());
		} catch (Exception e) {
			e.printStackTrace();			
		}
    }
